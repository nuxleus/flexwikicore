...
namespace FlexWiki.UnitTests
{
  [TestFixture]
	...
	{
    private AuthorizationHelper _helper = new AuthorizationHelper(); 
    ...
    private void AssertPermission(string nmspc, Permission permission, bool shouldHave, IPrincipal principal)
    {
      ...
      if (shouldHave)
      {
        ...
        Assert.IsTrue(_helper.HasPermission(nmspc, permission), message); 
      }
      else
      {
        ...
        Assert.IsFalse(_helper.HasPermission(nmspc, permission), message); 
      }
    }
