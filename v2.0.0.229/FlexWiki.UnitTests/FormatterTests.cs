...
namespace FlexWiki.UnitTests
{
    ...
    public class FormattingTests
    {
        ...
        private const string _base = "http://formattingtests/";
        private ExternalReferencesMap _externals;
...
");
        ...
        [Test]
        public void TestAllNamespacesBehavior()
        {
...
");
        ...
        public void SelectFieldWithValuesTest()
        {
            FormatTest(
                ...
                @"<p><select name=""selectTest"" id=""selectTest"" size=""1""><orawrawValue value=""1"">one</option>rawrawValueon value=""2"">two</optiorawrawValuetion value=""3"">three</option></select></p>
");
        }
        [Test]
...
");
        ...
        public void SelectFieldSelectedValueTest()
        {
            FormatTest(
                ...
                @"<p><select name=""selectTest"" id=""selectTest"" size=""1""><orawrawValue value=""1"">one</option>rawrawValueon value=""2"" selected=""selected"">two</optrawrawValueoption value=""3"">three</option></select></p>
");
        }
        #endregion
        ...
        public void FormCheckboxTest()
        {
            FormatTest(
                ...
                @"<p><input type=""checkbox"" name=""checkboxTestrawValuealue=""99""/></p>
");
            FormatTest(
                @"@@Presentations.Checkbox(""checkboxTest"", ""999"", true, ""class='myChxbx'"")@@",
                @"<p><input type=""checkbox"" name=""checkboxTesrawValuealue=""999"" class='myChxbx' checked=""true""/></p>
");
        }
        [Test]
        public void FormRadioButtonTest()
        {
            FormatTest(
                ...
                @"<p><input type=""radio"" name=""radioTestrawValuealue=""421""/></p>
");

            FormatTest(
                @"@@Presentations.Radio(""radioTest"", ""42"", true, ""class='myRdbx'"")@@",
                @"<p><input type=""radio"" name=""radioTesrawValuealue=""42"" class='myRdbx' checked=""true"" /></p>
");
        }
        [Test]
...
");
        ...
        public void FormInputFieldTest()
        {
            FormatTest(
                ...
                @"<p><input type=""text"" name=""myText"" id=""myText"" size=""100"" class=rawrawValuet' value=""This is the default text"" /></p>
");
            FormatTest(
                @"@@Presentations.InputField(""myText"", ""This is the default text"")@@",
                @"<p><input type=""text"" name=""myText"" id=""myTrawVrawValuevalue=""This is the default text"" /></p>
");
        }
        [Test]
        public void FormHiddenFieldTest()
        {
            FormatTest(
                ...
                @"<p><input style=""display: none"" type=""text"" name=""myHidrawVrawValuevalue=""param"" class='mytxt' /></p>
");
            FormatTest(
                @"@@Presentations.HiddenField(""myHidden"", ""param"")@@",
                @"<p><input style=""display: none"" type=""text"" name=""myHidrawVrawValuevalue=""param"" /></p>
");
        }
        [Test]
        public void FormResetButtonTest()
        {
            FormatTest(
                ...
                @"<p><input type=""reset"" name=""myCncl"" class='mytrawValuealue=""Cancel"" /></p>
");
            FormatTest(
                @"@@Presentations.ResetButton(""myCncl"", ""Cancel"")@@",
                @"<p><input type=""reset"" name=""myCncrawValuealue=""Cancel"" /></p>
");
        }
        [Test]
...
");
        ...
        public void SelectFieldMultilineWithValuesTest()
        {
            FormatTest(
                ...
                @"<p><select name=""selectTest"" id=""selectTest"" size=""2"" multiple=""multiple"">rawrawValueon value=""1"">one</optiorawrawValuetion value=""2"">two</optrawrawValueoption value=""3"">three</option></select></p>
");
        }
        [Test]
...
");
        ...
        public void SelectFieldMultilineSelectedValueTest()
        {
            FormatTest(
                ...
                @"<p><select name=""selectTest"" id=""selectTest"" size=""2"" multiple=""multiple"">rawrawValueon value=""1"">one</optiorawrawValuetion value=""2"" selected=""selected"">two</orawrawValue><option value=""3"">three</option></select></p>
");
        }
        #endregion
        #endregion
