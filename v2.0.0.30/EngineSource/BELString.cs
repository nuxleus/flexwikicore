...
namespace FlexWiki
{
	...
	public class BELString : BELObject, IComparable
	{
		...
		[ExposedMethod(ExposedMethodFlags.Default | ExposedMethodFlags.NeedContext, "Answer a substring of this string starting at the given character and possibly limited to the given number of characters")]
