    ...
    internal static class TestDataSets
    {
        internal static DataSet Default()
        {
            ...
            AddTopicRow(result,
                ref topicId,
                1,
                "TestHistoryDelete(2003-11-23-14-34-03-127.0.0.1)",
                new DateTime(2004, 11, 09),
                new DateTime(2004, 11, 09),
                1,
                0,
            ...
            AddTopicRow(result,
                ref topicId,
                1,
                "TestHistoryDelete(2003-11-23-14-34-06.1-127.0.0.1)",
                new DateTime(2004, 11, 06),
                new DateTime(2004, 11, 06),
                1,
                0,
            ...
            AddTopicRow(result,
                ref topicId,
                1,
                "TestHistoryDelete(2003-11-23-14-34-07-Name)",
                new DateTime(2004, 11, 05),
                new DateTime(2004, 11, 05),
                1,
                0,
            ...
            AddTopicRow(result,
                ref topicId,
                1,
                "TestHistoryDelete(2003-11-23-14-34-08.123-Name)",
                new DateTime(2004, 11, 04),
                new DateTime(2004, 11, 04),
                1,
                0,
